...
return [
    ...
    'moneypoolblock' => [
        ...
        'block_id_required' => 'The block ID field is required.',
        'block_id_integer' => 'The block ID must be an integer.',
        'block_id_exists' => 'The selected money pool block does not exist.',
    ],
];
